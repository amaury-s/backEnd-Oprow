...
public class AffluenceController {
    ...
    @RequestMapping(method = RequestMethod.GET, value="/day/{pIdAdmin}/{pArrivalTime}/{pIdService}")
    @CrossOrigin(origins = "http://localhost:8100")
    public @ResponseBody List<Integer> getWaitingTimeForAServiceForAnAdmin(@PathVariable int pIdAdmin, @PathVariable long pArrivalTime,
                                                                  @PathVariable long pIdService) {
